...
let PrimeBlockchain = require('./primeBlockchain.js');
let PrimeBlock = require('./primeBlock.js');
let PrimeClient = require('./primeClient.js');
let PrimeMiner = require('./primeMiner.js');
...
// Clients
let alice = new PrimeClient({name: "Alice", net: fakeNet});
let bob = new PrimeClient({name: "Bob", net: fakeNet});
let charlie = new PrimeClient({name: "Charlie", net: fakeNet});

// Miners
let minnie = new PrimeMiner({name: "Minnie", net: fakeNet});
let mickey = new PrimeMiner({name: "Mickey", net: fakeNet});

// Creating genesis block
let genesis = PrimeBlockchain.makeGenesis({
  blockClass: PrimeBlock,
...
let donald = new PrimeMiner({name: "Donald", net: fakeNet, startingBlock: genesis, miningRounds: 3000});
